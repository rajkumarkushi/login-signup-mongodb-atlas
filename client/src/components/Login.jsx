...
function Login({ setIsLoggedIn, isLoggedIn }) {
    ...
    const pstyle={marginTop:"3rem",fontSize:"1.2rem", fontWeight:"200", color:"yellow"}
        ...
        <div>
            <Grid align="center" className="wrapper">
                <Paper style={paperStyle} sx={{ width: { xs: '80vw', sm: '50vw', md: '40vw', lg: '30vw', xl: '20vw' }, height: { lg: '50vh' } }}>
                    ...
                    <p style={pstyle}>Don't have an account? <Link href="/signup" style={{color:'white'}}>SignUp</Link></p>
                </Paper>
            </Grid>
        </div>
    );
