...
function SignUp(){
    ...
    const loginstyle={color:"white",fontSize:"1.3rem"}
    const pstyle={fontSize:"1.2rem", fontWeight:"200", color:"yellow"}
    return (
        <div>
            <Grid align="center" className="wrapper">
                ...
                height:{
                    ...
                    <p style ={pstyle}>Already have an account?<Link href="/login" style={loginstyle}> Login</Link></p>
                </Paper>
            </Grid>
        </div>
    )
